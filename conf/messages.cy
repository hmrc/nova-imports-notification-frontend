...
##################################################################
# UVS4.0 - There is a problem with the data                     #
##################################################################
# TODO: Welsh translations to be supplied by content team.
uploadSpreadsheetErrorData.title = There is a problem with the data
uploadSpreadsheetErrorData.heading = There is a problem with the data
uploadSpreadsheetErrorData.caption = Add vehicle details
uploadSpreadsheetErrorData.paragraph = Correct the following errors in your spreadsheet, then upload it again.
uploadSpreadsheetErrorData.table.caption = Spreadsheet validation errors
uploadSpreadsheetErrorData.table.itemNumber = Item number
uploadSpreadsheetErrorData.table.problem = Error
uploadSpreadsheetErrorData.link = Return to create a vehicle notification
uploadSpreadsheetErrorData.buttonLabel = Upload an updated spreadsheet
