...
import controllers.vehicledetails.UpdateVehicleSpreadsheetController.guardPredicate
...
class UpdateVehicleSpreadsheetController @Inject() (
  val controllerComponents: MessagesControllerComponents,
  actions: Actions,
  formProvider: UpdateVehicleSpreadsheetFormProvider,
  view: UpdateVehicleSpreadsheetView
...
object UpdateVehicleSpreadsheetController {
