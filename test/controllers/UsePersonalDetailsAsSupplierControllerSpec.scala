...
class UsePersonalDetailsAsSupplierControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val usePersonalDetailsAsSupplierRoute       = routes.UsePersonalDetailsAsSupplierController.onPageLoad(NormalMode).url
  lazy val usePersonalDetailsAsSupplierSubmitRoute = routes.UsePersonalDetailsAsSupplierController.onSubmit(NormalMode).url
