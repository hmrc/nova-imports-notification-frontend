...
class BusinessPrivateControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val businessPrivateRoute = initialquestions.routes.BusinessPrivateController.onPageLoad(NormalMode).url
  ...
  "BusinessPrivate Controller" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        ...
        val view = application.injector.instanceOf[BusinessPrivateView]
    ...
    "must redirect to the next page when Business is submitted" in {
    ...
    "must redirect to the next page when Private individual is submitted" in {
