...
class PurchaserOrOnBehalfControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val purchaserOrOnBehalfRoute = initialquestions.routes.PurchaserOrOnBehalfController.onPageLoad(NormalMode).url
  ...
  "PurchaserOrOnBehalfController" - {
    ...
    "must return OK and the correct view for a GET" in {
      ...
      running(application) {
        ...
        val view = application.injector.instanceOf[PurchaserOrOnBehalfView]
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      running(application) {
        ...
        status(result) mustEqual OK
        contentAsString(result) mustEqual view(form.fill(PurchaserOrOnBehalf.Purchaser), NormalMode)(request, messages(application)).toString
      }
    }
