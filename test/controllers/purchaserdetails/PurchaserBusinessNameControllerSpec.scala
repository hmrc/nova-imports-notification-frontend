...
package controllers.purchaserdetails
...
class PurchaserBusinessNameControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val purchaserBusinessNameRoute       = purchaserdetails.routes.PurchaserBusinessNameController.onPageLoad(NormalMode).url
  lazy val purchaserBusinessNameChangeRoute = purchaserdetails.routes.PurchaserBusinessNameController.onPageLoad(CheckMode).url
