...
class PurchaserNameControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val purchaserNameRoute       = purchaserdetails.routes.PurchaserNameController.onPageLoad(NormalMode).url
  lazy val purchaserNameChangeRoute = purchaserdetails.routes.PurchaserNameController.onPageLoad(CheckMode).url
