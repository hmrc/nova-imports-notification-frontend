...
class NoAuthorisedClientsControllerSpec extends SpecBase {
  ...
  private lazy val noAuthorisedClientsRoute =
    clientselection.routes.NoAuthorisedClientsController.onPageLoad().url
  ...
  "NoAuthorisedClientsController" - {
    ...
    "onPageLoad" - {
      ...
      "must be served from /no-clients" in {
        ...
        running(application) {
          clientselection.routes.NoAuthorisedClientsController.onPageLoad().url mustEqual "/nova-imports/no-clients"
        }
      }
