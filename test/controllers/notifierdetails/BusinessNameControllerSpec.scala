...
class BusinessNameControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val businessNameRoute       = notifierdetails.routes.BusinessNameController.onPageLoad(NormalMode).url
  lazy val businessNameChangeRoute = notifierdetails.routes.BusinessNameController.onPageLoad(CheckMode).url
