...
import pages.sections.initialquestions.{AgentClientVehicleBusinessUsePage, BusinessOrPrivatePage, VehicleBusinessUsePage, VehicleFromEuPage}
...
class YourDetailsCheckYourAnswersControllerSpec extends SpecBase with MockitoSugar {
  ...
  private lazy val yourDetailsCheckYourAnswersRoute = notifierdetails.routes.YourDetailsCheckYourAnswersController.onPageLoad().url
