...
class EmailAddressControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val emailAddressRoute       = notifierdetails.routes.EmailAddressController.onPageLoad(NormalMode).url
  lazy val emailAddressChangeRoute = notifierdetails.routes.EmailAddressController.onPageLoad(CheckMode).url
