...
class PhoneNumberControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val phoneNumberRoute       = notifierdetails.routes.PhoneNumberController.onPageLoad(NormalMode).url
  lazy val phoneNumberSubmitRoute = notifierdetails.routes.PhoneNumberController.onSubmit(NormalMode).url
  lazy val phoneNumberChangeRoute = notifierdetails.routes.PhoneNumberController.onPageLoad(CheckMode).url
