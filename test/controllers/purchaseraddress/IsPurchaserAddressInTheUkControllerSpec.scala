...
class IsPurchaserAddressInTheUkControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val isPurchaserAddressInTheUkRoute       = purchaseraddress.routes.IsPurchaserAddressInTheUkController.onPageLoad(NormalMode).url
  lazy val isPurchaserAddressInTheUkSubmitRoute = purchaseraddress.routes.IsPurchaserAddressInTheUkController.onSubmit(NormalMode).url
