...
import models.{AddressJourney, DraftId, NormalMode, UserAnswers}
...
class IsYourAddressInTheUkControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val isYourAddressInTheUkRoute       = notifieraddress.routes.IsYourAddressInTheUkController.onPageLoad(NormalMode).url
  lazy val isYourAddressInTheUkSubmitRoute = notifieraddress.routes.IsYourAddressInTheUkController.onSubmit(NormalMode).url
