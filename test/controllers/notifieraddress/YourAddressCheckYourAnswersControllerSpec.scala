...
class YourAddressCheckYourAnswersControllerSpec extends SpecBase with MockitoSugar {
  ...
  private lazy val onPageLoadRoute: String      = notifieraddress.routes.YourAddressCheckYourAnswersController.onPageLoad().url
  private lazy val onSubmitRoute: String        = notifieraddress.routes.YourAddressCheckYourAnswersController.onSubmit().url
  private lazy val onChangeAddressRoute: String = notifieraddress.routes.YourAddressCheckYourAnswersController.onChangeAddress().url
