...
class SupplierNameFormProviderSpec extends StringFieldBehaviours {

  val requiredTitleKey = "supplierName.titleField.error.required"
  val lengthTitleKey   = "supplierName.titleField.error.length"
  val formatTitleKey   = "supplierName.titleField.error.format"

  val requiredFirstKey = "supplierName.firstName.error.required"
  val lengthFirstKey   = "supplierName.firstName.error.length"
  val formatFirstKey   = "supplierName.firstName.error.format"

  val requiredLastKey = "supplierName.lastName.error.required"
  val lengthLastKey   = "supplierName.lastName.error.length"
  val formatLastKey   = "supplierName.lastName.error.format"

  val form = new SupplierNameFormProvider()()
