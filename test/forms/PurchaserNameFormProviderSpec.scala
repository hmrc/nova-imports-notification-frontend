...
class PurchaserNameFormProviderSpec extends StringFieldBehaviours {

  val requiredTitleKey = "purchaserName.titleField.error.required"
  val lengthTitleKey   = "purchaserName.titleField.error.length"
  val formatTitleKey   = "purchaserName.titleField.error.format"

  val requiredFirstKey = "purchaserName.firstName.error.required"
  val lengthFirstKey   = "purchaserName.firstName.error.length"
  val formatFirstKey   = "purchaserName.firstName.error.format"

  val requiredLastKey = "purchaserName.lastName.error.required"
  val lengthLastKey   = "purchaserName.lastName.error.length"
  val formatLastKey   = "purchaserName.lastName.error.format"

  val form = new PurchaserNameFormProvider()()
